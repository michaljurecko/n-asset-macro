...
class PathsTest extends TestCase
{
	...
	public function testFormatMultipleVars()
	{
		...
		Assert::same(
			'/base/path/fixtures/assets/compiled/main.fc730c89c4255.js',
			$latte->renderToString('{asset "assets/compiled/main.js", "%basePath%%path%"}')
		);
	}
	...
	public function testStripOptionalSlashes()
	{
		$latte = $this->createLatte();
		Assert::same(
			'/base/path/fixtures/assets/compiled/other.8h9hfj5vvh4jf.js',
	...
	public function testAbsolutePathByPathPrefix()
	{
		$latte = $this->createLatte();
		Assert::same(
			'http://www.example.com/base/path/fixtures/assets/compiled/other.8h9hfj5vvh4jf.js',
			$latte->renderToString('{asset "//assets/compiled/other.js"}')
		);
	}
